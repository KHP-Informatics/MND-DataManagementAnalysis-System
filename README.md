...
### Development of iRODS file storage system for level 1 data
...
We will deploy this "intelligent file system" to provide the foundation to the project through which data will be collected, stored, managed and archived. The computer scientist will deploy iRODS and harvest current clinical and genomic datasets within this environment. This will be an extension to the systems we have already implemented.
